class SiteFooter extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
      <footer class="relative z-20 -mt-12 bg-black text-white px-6 pb-16 pt-8 md:px-12 md:pb-24 md:pt-12 w-full rounded-t-3xl">

        <!-- Top Section -->
        <div class="flex flex-col md:flex-row justify-between mb-24 md:mb-32">

          <!-- Logo -->
          <div class="mb-12 md:mb-0">
            <img src="assests/2.svg" alt="Trace Logo" class="h-16 md:h-24 w-auto">
          </div>

          <!-- Main Links -->
          <div class="w-full md:w-[45%]">
            <ul class="flex flex-col text-2xl md:text-[32px] font-bold tracking-tight">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end">
          ...
          <!-- Text and Socials -->
          <div class="w-full md:w-[35%] mb-16 md:mb-0">
            <p class="text-[12px] md:text-sm text-white/90 leading-relaxed mb-8 font-medium">
              Few companies can say they have the world at their feet, both literally and figuratively.
              As a global marketer of branded footwear, apparel, and accessories, this apt saying speaks
              to our focus on building great brands and making amazing products, and the bright future before us.
            </p>
            <div class="flex flex-col gap-3 text-[12px] md:text-[13px] font-medium text-white/90">
